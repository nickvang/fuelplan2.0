...
export const translations = {
  en: {
    ...
    'gel.sectionTitle': 'Supplme Liquid Energy Gel',
    'gel.spec': '40ml · 32g carbs · 2:1 glucose:fructose · liposomal delivery',
    'gel.totalGels': 'Total gels',
    'gel.totalCarbs': 'Total carbs',
    'gel.kcal': 'kcal',
    'gel.timing': 'When to take',
    'gel.withWater': 'Always take with 150–200ml water to optimise absorption',
    'gel.scienceBasis': 'The science behind this dosing',
    'gel.notRequired': 'No gel required for this session',
    'gel.drinkDirect': 'Drink directly from sachet — no mixing required',
    'gel.buy': 'Buy Energy Gel',
    'gel.fuelRole': '→ Fuel your muscles',
    'gel.hydrateRole': '→ Replace sweat losses',
    ...
    // Activity pace labels
    'activity.swimPace': 'Swim Pace',
    'activity.bikeSpeed': 'Bike Speed',
    'activity.runPace': 'Run Pace',

    // Result page — hero numbers & gel summary
    'result.totalSodium': 'Total Sodium',
    'result.energyGels': 'Energy Gels',
    'result.totalCarbs': 'Total Carbs',
    'result.carbsPerHour': 'Carbs/hr',
    'result.fuelKcal': 'Fuel kcal',

    // Result page — stage race labels
    'result.dayBefore': 'Day Before',
    'result.stageMorning': 'Stage Morning',
    'result.duringStage': 'During Stage {day}',
    'result.queenStageWarning': 'Queen Stage: Extra long effort increases hyponatremia risk if you drink plain water without sodium. Never skip sachets.',

    // Result page — shop card
    'result.liquidElectrolyteSachet': 'Liquid Electrolyte Sachet',
    'result.energyGelProduct': 'Energy Gel',

    // Premium display
    'result.precisionHydrationPlan': 'Precision Hydration Plan',
    'result.performanceProtocol': 'Performance Protocol',
    'result.keyInsights': 'Key Insights',
    'result.trainingVsRaceDay': 'Training vs Race Day',
    'result.trainingNote': "TRAINING: Flexibility allowed. You can underhydrate, do low-carb days, stress your system. Training is where you test products, find your limits, build resilience. Perfect precision isn't required.",
    'result.raceDayNote': 'RACE DAY: Everything changes. Intensity spikes, sweat rate increases 15-25%, sodium loss accelerates dramatically, gut sensitivity rises. Your margin for error shrinks to near zero. Dehydration hits harder and earlier at race pace. This demands precise sodium replacement (65-80% of sweat loss), strict timing (never wait until thirsty), pre-loading with sodium, and zero experimentation.',

    // Image / ShareCard canvas strings
    'image.yourRaceDay': 'Your Race Day',
    'image.hydrationPlan': 'Hydration Plan',
    'image.electrolyteSachets': 'ELECTROLYTE SACHETS',
    'image.fluidLoss': 'FLUID LOSS',
    'image.totalSodium': 'TOTAL SODIUM',
    'image.sachetSummary': 'SACHET SUMMARY',
    'image.preRace': 'PRE-RACE',
    'image.during': 'DURING',
    'image.postRace': 'POST-RACE',
    'image.energyGelSummary': 'ENERGY GEL SUMMARY',
    'image.totalGels': 'TOTAL GELS',
    'image.totalCarbs': 'TOTAL CARBS',
    'image.carbsPerHour': 'CARBS / HR',
    'image.fuelKcal': 'FUEL KCAL',
    'image.notRequired': 'not required',
    'image.protocol': '48-HOUR RACE DAY PROTOCOL',
    'image.target': 'TARGET',
    'image.t24hours': 'T-24 hours',
    'image.dayBefore': 'Day Before',
    'image.waterThroughoutDay': 'Water throughout the day',
    'image.withDinner': 'With dinner',
    'image.water23L': '2-3 L water',
    'image.water500ml': '500 ml water',
    'image.raceMorningLabel': 'Race morning',
    'image.raceMorningTitle': 'Race Morning',
    'image.wakeUp': '-3h: Wake up',
    'image.preLoad': '-2h: Pre-load',
    'image.energyGelPre': '-15min: Energy gel',
    'image.finalSips': '-30min: Final',
    'image.sipsOnly': 'Sips only',
    'image.raceStart': 'RACE START',
    'image.duringRace': 'During Race',
    'image.electrolyteSachetSub': 'ELECTROLYTE SACHET',
    'image.sachetNum': 'Sachet #{n}',
    'image.moreSachets': '+{n} more sachets',
    'image.spreadEvenly': 'Spread evenly',
    'image.energyGelSub': 'ENERGY GEL',
    'image.gelNum': 'Gel #{n}',
    'image.moreGels': '+{n} more gels',
    'image.everyMin': '1 every {min} min',
    'image.waterPerHour': 'Water per hour',
    'image.finishLine': 'Finish line',
    'image.recovery': 'Recovery',
    'image.recoveryImmediately': '0h: Immediately',
    'image.recover12h': '1-2h: Recover',
    'image.rehydrate26h': '2-6h: Rehydrate',
    'image.disclaimer': 'This plan is for educational purposes only. Consult a healthcare provider.',
  },
  da: {
    // Header
    ...
    'gel.sectionTitle': 'Supplme Liquid Energy Gel',
    'gel.spec': '40ml · 32g kulhydrater · 2:1 glukose:fruktose · liposomal levering',
    'gel.totalGels': 'Gels i alt',
    'gel.totalCarbs': 'Kulhydrater i alt',
    'gel.kcal': 'kcal',
    'gel.timing': 'Hvornår du tager dem',
    'gel.withWater': 'Tag altid med 150–200ml vand for bedre absorption',
    'gel.scienceBasis': 'Videnskabeligt grundlag',
    'gel.notRequired': 'Ingen gel nødvendig til denne session',
    'gel.drinkDirect': 'Drik direkte fra sachetten — ingen blanding nødvendig',
    'gel.buy': 'Køb Energy Gel',
    'gel.fuelRole': '→ Brændstof til dine muskler',
    'gel.hydrateRole': '→ Erstat sved-tab',
    ...
    // Activity pace labels
    'activity.swimPace': 'Svømmehastighed',
    'activity.bikeSpeed': 'Cykelhastighed',
    'activity.runPace': 'Løbetempo',

    // Result page — hero numbers & gel summary
    'result.totalSodium': 'Total Natrium',
    'result.energyGels': 'Energigelé',
    'result.totalCarbs': 'Kulhy. i alt',
    'result.carbsPerHour': 'Kulhy./t',
    'result.fuelKcal': 'Brændstof kcal',

    // Result page — stage race labels
    'result.dayBefore': 'Dagen Før',
    'result.stageMorning': 'Etapemorgen',
    'result.duringStage': 'Under Etape {day}',
    'result.queenStageWarning': 'Dronningeetape: Ekstra lang indsats øger risikoen for hyponatriæmi, hvis du drikker vand uden natrium. Spring aldrig sachets over.',

    // Result page — shop card
    'result.liquidElectrolyteSachet': 'Flydende Elektrolyt Sachet',
    'result.energyGelProduct': 'Energigelé',

    // Premium display
    'result.precisionHydrationPlan': 'Præcis Hydrationsplan',
    'result.performanceProtocol': 'Præstationsprotokol',
    'result.keyInsights': 'Vigtige Indsigter',
    'result.trainingVsRaceDay': 'Træning vs. Løbsdag',
    'result.trainingNote': 'TRÆNING: Fleksibilitet er tilladt. Du kan underhydrere, have lavkulhydrat-dage og stresse systemet. Træning er der, hvor du tester produkter, finder dine grænser og opbygger robusthed. Perfekt præcision er ikke nødvendig.',
    'result.raceDayNote': 'LØBSDAG: Alt ændrer sig. Intensiteten stiger, svedproduktionen øges med 15-25%, natriumtab accelererer dramatisk og mavefølsomheden stiger. Din fejlmargin skrumper til næsten nul. Dehydrering rammer hårdere og tidligere ved løbstempo. Dette kræver præcis natriumerstatning (65-80% af svedtab), streng timing (vent aldrig til du er tørstig), forindlæsning med natrium og nul eksperimentering.',

    // Image / ShareCard canvas strings
    'image.yourRaceDay': 'Din Løbsdag',
    'image.hydrationPlan': 'Hydrationsplan',
    'image.electrolyteSachets': 'ELEKTROLYT SACHETS',
    'image.fluidLoss': 'VÆSKETAB',
    'image.totalSodium': 'TOTAL NATRIUM',
    'image.sachetSummary': 'SACHET OVERSIGT',
    'image.preRace': 'FØR LØB',
    'image.during': 'UNDER',
    'image.postRace': 'EFTER LØB',
    'image.energyGelSummary': 'ENERGIGELÉ OVERSIGT',
    'image.totalGels': 'GELÉER I ALT',
    'image.totalCarbs': 'KULHY. I ALT',
    'image.carbsPerHour': 'KULHY. / T',
    'image.fuelKcal': 'BRÆNDSTOF KCAL',
    'image.notRequired': 'ikke nødvendig',
    'image.protocol': '48-TIMERS LØBSDAGSPROTOKOL',
    'image.target': 'MÅL',
    'image.t24hours': 'T-24 timer',
    'image.dayBefore': 'Dagen Før',
    'image.waterThroughoutDay': 'Vand hele dagen',
    'image.withDinner': 'Til middag',
    'image.water23L': '2-3 L vand',
    'image.water500ml': '500 ml vand',
    'image.raceMorningLabel': 'Løbsmorgen',
    'image.raceMorningTitle': 'Løbsmorgen',
    'image.wakeUp': '-3t: Vågn op',
    'image.preLoad': '-2t: Forindlæs',
    'image.energyGelPre': '-15min: Energigelé',
    'image.finalSips': '-30min: Afsluttende',
    'image.sipsOnly': 'Kun nips',
    'image.raceStart': 'LØBSSTART',
    'image.duringRace': 'Under Løb',
    'image.electrolyteSachetSub': 'ELEKTROLYT SACHET',
    'image.sachetNum': 'Sachet #{n}',
    'image.moreSachets': '+{n} flere sachets',
    'image.spreadEvenly': 'Fordel jævnt',
    'image.energyGelSub': 'ENERGIGELÉ',
    'image.gelNum': 'Gelé #{n}',
    'image.moreGels': '+{n} flere geléer',
    'image.everyMin': '1 hvert {min} min',
    'image.waterPerHour': 'Vand pr. time',
    'image.finishLine': 'Mållinje',
    'image.recovery': 'Restitution',
    'image.recoveryImmediately': '0t: Straks',
    'image.recover12h': '1-2t: Restituér',
    'image.rehydrate26h': '2-6t: Genhydrer',
    'image.disclaimer': 'Denne plan er kun til uddannelsesmæssige formål. Konsulter en sundhedsfaglig person.',
  },
};
