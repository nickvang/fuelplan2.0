    ...
    <div className="border border-gray-200 rounded-lg overflow-hidden">
      <div className="px-3.5 py-2.5 border-b border-gray-200 bg-gray-50">
        <p className="text-[11px] font-semibold uppercase tracking-wide text-gray-500">
          {isStageRace
            ? `Hydration sachet summary / ${total} total across ${stageRaceTotals.stages} stage${stageRaceTotals.stages !== 1 ? 's' : ''}`
            : `Hydration sachet summary / ${total} total`}
        </p>
      </div>
      <div className="grid grid-cols-3 gap-px bg-gray-200">
        <div className="bg-white p-3 sm:p-4 text-center">
          <p className="text-2xl sm:text-3xl font-bold text-[#0a0a0a]">{preCount}</p>
        ...
        <div className="bg-white p-3 sm:p-4 text-center">
          <p className="text-2xl sm:text-3xl font-bold text-[#0a0a0a]">{duringCount}</p>
        ...
        <div className="bg-white p-3 sm:p-4 text-center">
          <p className="text-2xl sm:text-3xl font-bold text-[#0a0a0a]">{postCount}</p>
