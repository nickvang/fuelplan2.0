...
export default function LogicVerification() {
  ...
  return (
    <div className="container mx-auto px-4 py-6 sm:p-8 max-w-[1200px] min-w-0">
      <div className="mb-6 sm:mb-8">
        <h1 className="text-2xl sm:text-4xl font-bold mb-2">✅ Logic Verification</h1>
        <p className="text-sm sm:text-base text-muted-foreground">
          Verifying sachet timing calculations match session duration and totals
        </p>
      </div>

      <Card className="p-4 sm:p-6 mb-6 bg-green-50 dark:bg-green-950/20 overflow-hidden">
      ...
      <Card className="mt-6 sm:mt-8 p-4 sm:p-6 bg-blue-50 dark:bg-blue-950/20 overflow-hidden">
        <h2 className="text-lg sm:text-xl font-bold mb-4">✅ Scientific Validation</h2>
